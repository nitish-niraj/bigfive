const english = {
  ...
  frontpage: {
    ...
    tests_taken: '<green>{n}</green> people have taken the test',
    compare: {
    ...
    cards: {
      open: {
        ...
        text: 'Get unique personality insights tailored just for you.'
      },
      free: {
        title: 'Actionable Feedback',
        text: 'Receive practical advice to enhance your strengths.'
      },
      scientific: {
        title: 'Scientific',
      ...
      translated: {
        title: 'Translated',
        text: 'Available in both English and Hindi.'
      }
    },
    description: {
      top: 'Learn to know yourself better with a <violet>free</violet> personality test.',
      subtop: 'The',
      subtop2:
